...
public class RecipeServiceUnitTest {
    ...
    void testGetTrendingRecipes() {
        ...
        // Act
        Page<RecipeDTO> result = recipeService.getTrendingRecipes(0, 10, "position", "asc");
    ...
    void testGetTrendingRecipesByDifficulty() {
        ...
        // Act
        Page<RecipeDTO> result = recipeService.getTrendingRecipesByDifficulty(0, 10, "position","asc","easy");
